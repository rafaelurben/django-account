...
urlpatterns = [
    ...
    path(
        "logout", views.LogoutView.as_view(next_page=reverse_lazy("account:login")), name="logout"
    ),
    path("profile", views.profile, name="profile"),
    path("oauth-management", views.oauth_management, name="oauth-management"),
    path("passkey-management", views.passkey_management, name="passkey-management"),
    path("delete-password", views.delete_password, name="delete-password"),
